...
- [INFO] Servidor n8n versão atualizada 2.23.4 rodando no Android Galaxy S20+ com Termux
- [INFO] Acesso remoto via Cloudflare Tunnel no endereço n8n.iasol.space 
